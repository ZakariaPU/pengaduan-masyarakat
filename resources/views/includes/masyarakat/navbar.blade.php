...
<header class="header">
  <div class="header-container">
      ...
      <div class="flex justify-center flex-1">
        <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 custom-link" href="{{ url('user') }}">
          <span class="ml-4">Dashboard</span>
        </a>
        <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 custom-link" href="{{ url('user/pengaduan') }}">
